...
![Static ip](Static_ip_config.png)
![ipconfig](Ipconfig.png)

- Installing #ActiveDirectory with additional tools:
  * Managing user accounts and giving them various privilages
  
  ![Users&Groups](Users_and_groups.png)
  
  * Group policy managment

  ![Group_Policy_Editing](gsp.png)

  * Sharing folders

  ![folder sharing](fs.png)
